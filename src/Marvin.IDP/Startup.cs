    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            var marvinIDPDataDBConnectionString =
                "Server=ganesh-pc; Database=ImageGallery; User ID=sa; Password=Nirvana3;MultipleActiveResultSets=true;";
        ...
        {
            string thumbPrint = "c348ef91dce97af28587bae05842506c84925854";
